        ...
        function c(passed_month, passed_year, calNum) {
            ...
            while (!u) {
                if (daysArray[r] == calMonthArray[0].weekday) {
                    ...
                    calendar.datesBody.append('<div class="date blank"></div>');
                    r++;
                }
            }
            for (var cell = 0; cell < 42 - r; cell++) {
                ...
                if (cell >= calMonthArray.length) {
                    ...
                    var formattedDate =
                        iter_date.getFullYear() +
                        "-" +
                        String(iter_date.getMonth() + 1).padStart(2, "0") +
                        "-" +
                        String(iter_date.getDate()).padStart(2, "0");
                    ...
                    if (
                        ...
                        m =
                            '<div class="date past-date" data-date="' +
                            formattedDate +
                            '">';
                    } else if (checkToday(iter_date)) {
                        m =
                            '<div class="date today" data-date="' +
                            formattedDate +
                            '">';
                    } else {
                        m =
                            '<div class="date future-date" data-date="' +
                            formattedDate +
                            '">';
                    }
            ...
            calendar.calHeader
                .find("h2")
                .text(i[passed_month] + " " + passed_year);
                    ...
                    if (
                        ...
                        for (var d in daysToCompare) {
                            dateElements.each(function (index) {
                                if (
                                    parseInt($(this).text()) == daysToCompare[d]
                                ) {
        ...
        function makeMonthArray(passed_month, passed_year) {
            ...
            for (
                ...
                e.push({
                    ...
                    weekday:
                        daysArray[getWeekdayNum(passed_year, passed_month, r)],
                });
            }
            return e;
        }
